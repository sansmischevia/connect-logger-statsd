...
module.exports = function(options) {
  ...
  if (options.max_status_code && typeof options.max_status_code === Number) {
    max_status_code = options.max_status_code;
  }
  ...
  return function(req, res, next){
    ...
    if (ex) {
      ...
      res.end = function(chunk, encoding) {
        ...
        // Do not report request time if the status code is > than 400, or other user specified number
        if (res.statusCode && res.statusCode >= max_status_code) {
          return;
        }
